...
import com.ourgiant.docscrubber.util.DesktopUtils;
import com.ourgiant.docscrubber.util.LogPaths;
...
/**
 * Live-ish view of the app's own current log file, since nothing else surfaces it without leaving
 * the app. Non-modal (so it can stay open alongside normal use) and auto-refreshes on a timer
 * while visible.
 */
