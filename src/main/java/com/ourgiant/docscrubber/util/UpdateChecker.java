...
/**
 * Checks GitHub's releases API for a newer DocScrubber version. This is the app's only outbound
 * network call at runtime — everything else (parsing, rules, scoring) is fully offline, since
 * the tool exists to process hostile untrusted documents. Ported from kiro-control-panel's same
 * feature.
 */
public final class UpdateChecker {
    private static final Logger logger = LoggerFactory.getLogger(UpdateChecker.class);
    private static final String RELEASES_URL = "https://api.github.com/repos/OurGiant/doc-scrubber/releases/latest";
    ...
    public static Optional<ReleaseInfo> fetchLatestRelease() {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("User-Agent", "doc-scrubber")
